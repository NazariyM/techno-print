...
!function (a) {
  "use strict";
  function b(b) {
    b = a.extend({}, l, b || {});for (var d = a(this), e = 0, f = d.length; f > e; e++) {
      c(d.eq(e), b);
    }return d;
  }function c(b, c) {
    if (!b.hasClass("stepper-input")) {
      c = a.extend({}, c, b.data("stepper-options"));var f = parseFloat(b.attr("min")),
          g = parseFloat(b.attr("max")),
          h = parseFloat(b.attr("step")) || 1;b.addClass("stepper-input").wrap('<div class="stepper ' + c.customClass + '" />').after('<span class="stepper-arrow up">' + c.labels.up + '</span><span class="stepper-arrow down">' + c.labels.down + "</span>");var i = b.parent(".stepper"),
          k = a.extend({ $stepper: i, $input: b, $arrow: i.find(".stepper-arrow"), min: void 0 === (typeof f === "undefined" ? "undefined" : _typeof(f)) || isNaN(f) ? !1 : f, max: void 0 === (typeof g === "undefined" ? "undefined" : _typeof(g)) || isNaN(g) ? !1 : g, step: void 0 === (typeof h === "undefined" ? "undefined" : _typeof(h)) || isNaN(h) ? 1 : h, timer: null }, c);k.digits = j(k.step), b.is(":disabled") && i.addClass("disabled"), i.on("keypress", ".stepper-input", k, d), i.on("touchstart.stepper mousedown.stepper", ".stepper-arrow", k, e).data("stepper", k);
    }
  }function d(a) {
    var b = a.data;(38 === a.keyCode || 40 === a.keyCode) && (a.preventDefault(), g(b, 38 === a.keyCode ? b.step : -b.step));
  }function e(b) {
    b.preventDefault(), b.stopPropagation(), f(b);var c = b.data;if (!c.$input.is(":disabled") && !c.$stepper.hasClass("disabled")) {
      var d = a(b.target).hasClass("up") ? c.step : -c.step;c.timer = h(c.timer, 125, function () {
        g(c, d, !1);
      }), g(c, d), a("body").on("touchend.stepper mouseup.stepper", c, f);
    }
  }function f(b) {
    b.preventDefault(), b.stopPropagation();var c = b.data;i(c.timer), a("body").off(".stepper");
  }function g(a, b) {
    var c = parseFloat(a.$input.val()),
        d = b;void 0 === (typeof c === "undefined" ? "undefined" : _typeof(c)) || isNaN(c) ? d = a.min !== !1 ? a.min : 0 : a.min !== !1 && c < a.min ? d = a.min : d += c;var e = (d - a.min) % a.step;0 !== e && (d -= e), a.min !== !1 && d < a.min && (d = a.min), a.max !== !1 && d > a.max && (d -= a.step), d !== c && (d = k(d, a.digits), a.$input.val(d).trigger("change"));
  }function h(a, b, c) {
    return i(a), setInterval(c, b);
  }function i(a) {
    a && (clearInterval(a), a = null);
  }function j(a) {
    var b = String(a);return b.indexOf(".") > -1 ? b.length - b.indexOf(".") - 1 : 0;
  }function k(a, b) {
    var c = Math.pow(10, b);return Math.round(a * c) / c;
  }var l = { customClass: "", labels: { up: "Up", down: "Down" } },
      m = { defaults: function defaults(b) {
      return l = a.extend(l, b || {}), a(this);
    }, destroy: function destroy() {
      return a(this).each(function () {
        var b = a(this).data("stepper");b && (b.$stepper.off(".stepper").find(".stepper-arrow").remove(), b.$input.unwrap().removeClass("stepper-input"));
      });
    }, disable: function disable() {
      return a(this).each(function () {
        var b = a(this).data("stepper");b && (b.$input.attr("disabled", "disabled"), b.$stepper.addClass("disabled"));
      });
    }, enable: function enable() {
      return a(this).each(function () {
        var b = a(this).data("stepper");b && (b.$input.attr("disabled", null), b.$stepper.removeClass("disabled"));
      });
    } };a.fn.stepper = function (a) {
    return m[a] ? m[a].apply(this, Array.prototype.slice.call(arguments, 1)) : "object" != (typeof a === "undefined" ? "undefined" : _typeof(a)) && a ? this : b.apply(this, arguments);
...
$(function () {
  ...
  function previewImages() {
    var $send = $('.js-send');
    var $sendPreview = $send.find('.send__files');
